...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Feedback mechanism used to communicate important information to the user. It appears as a small, non-intrusive notification or "toaster" that appears on the screen, and provides information about an event or action that has occurred.',
      },
    },
  },
...
const Template: StoryFn = () => {
  ...
  return (
    <>
      ...
      <Button onClick={showAlert} variant='secondary'>
        {' '}
        Click me
      </Button>
...
export const Error: StoryObj = {
  render: () => {
    ...
    return (
      <Button onClick={showAlert} variant='danger'>
        Delete
      </Button>
    )
  },
...
export const Success: StoryObj = {
  render: () => {
    ...
    return (
      <Button onClick={showAlert} variant='success'>
        Save
      </Button>
    )
  },
...
export const ExtraOptions: StoryObj = {
  render: () => {
    const showAlert = () => {
      alert.info(
        'Info Alert',
    ...
    return (
      <Button onClick={showAlert} variant='neutral'>
        Click me
      </Button>
    )
  },
