...
Interactive.parameters = {
  docs: {
    storyDescription: 'Table headers have two extra variations, one that allows you to search contents in a given column and another that allows you to sort the contents. These variations can also be combined.',
    source: {
      code: `
...
Custom.parameters = {
  docs: {
    storyDescription: 'Cells can receive any content the user wants, from text, links, checkboxes, tags, etc.',
    source: {
      code: `
// myCustomTable.tsx
...
